...
const WizardsSix = () => {
  ...
  const cartDeleted = (id) => {
    ...
    // dispatch(cartDelete(id, cartData));
  };
            ...
            steps={[
              {
                title: (
                  <div className="wizard-item">
                    ...
                    <img
                      src={require("../../../../static/img/wizards/1.svg")}
                      alt=""
                    />
                  </div>
                ),
              ...
              },
              {
                title: (
                  <div className="wizard-item">
                    ...
                    <img
                      src={require("../../../../static/img/wizards/1-1.svg")}
                      alt=""
                    />
                  </div>
                ),
              ...
              },
              {
                title: (
                  <div className="wizard-item">
                    ...
                    <img
                      src={require("../../../../static/img/wizards/2.svg")}
                      alt=""
                    />
                  </div>
                ),
                      ...
                      <Row justify="center">
                        <Col xs={24}>
                          <div className="payment-method-form">
                            <Heading as="h4">
                              3. Please Please Select Your Payment Method
                            </Heading>
              ...
              },
              {
                title: (
                  <div
                    className={`wizard-item ${status === "finish" && "block"}`}
                  >
                    <h2 className={`${status === "finish" ? "none" : "block"}`}>
                      Review Order
                    </h2>
                    ...
                    <img
                      src={require(`../../../../static/img/wizards/${
                        status !== "finish" ? 3 : 4
                      }.svg`)}
                      alt=""
                    />
                                    ...
                                    <OrderSummary>
                                      <div className="invoice-summary-inner">
                                        ...
                                        >
                                          ...
                                          <span className="summary-total-amount">{`$${subtotal +
                                            30 -
                                            20}`}</span>
                                        </Heading>
                                      </div>
