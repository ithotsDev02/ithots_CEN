          ...
          isbutton={
            <div className="card-nav">
              <ul>
                ...
                <li
                  className={
                    state.closeDealTabActive === "month"
                      ? "active"
                      : "deactivate"
                  }
                >
                  ...
                  return (
                    <div key={key + 1} className="card-bar-top">
                      <h4>
                        ...
                        <p
                          className={
                            item.percent >= 50 ? "growth-up" : "growth-down"
                          }
                        >
                          ...
                          <span className="deal-percentage">
                            <FeatherIcon
                              icon={
                                item.percent >= 50 ? "arrow-up" : "arrow-down"
                              }
                              size={14}
                            />
                            {item.percent}%
